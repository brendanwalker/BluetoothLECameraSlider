...
namespace StreamlabsEventReceiver
{
    public class StreamlabsEventClient
    {
        ...
        public event EventHandler<EventArgs> StreamlabsSocketConnectFailed;
        ...
        public void Connect(string token)
        {
            ...
            _sio.On(SocketIO.EVENT_CONNECT_ERROR, () => SocketConnectFailed());
        ...
        private void SocketConnectFailed()
        {
            StreamlabsSocketConnectFailed?.Invoke(this, null);
            IsConnected = false;
        }
